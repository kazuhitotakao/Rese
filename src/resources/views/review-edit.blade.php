...
@section('css')
    ...
    @if (app('env') == 'production')
        <link href="{{ secure_asset('css/review-edit.css') }}" rel="stylesheet">
    @endif
@endsection
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="review col-md-6 mt-5">
                <form class="review__form" id="upload_form" action="{{ route('reviews.update', ['shop_id' => $shop_id]) }}"
                        ...
                        <div class="review__form-content">
                            <div class="review__rating-options">
                                <input class="review__rating-input visually-hidden" id="rating-5" name="rating"
                                    type="radio" value="5" @if (old('rating', $review_rating) == '5') checked @endif>
                                ...
                                <input class="review__rating-input visually-hidden" id="rating-4" name="rating"
                                    type="radio" value="4" @if (old('rating', $review_rating) == '4') checked @endif>
                                ...
                                <input class="review__rating-input visually-hidden" id="rating-3" name="rating"
                                    type="radio" value="3" @if (old('rating', $review_rating) == '3') checked @endif>
                                ...
                                <input class="review__rating-input visually-hidden" id="rating-2" name="rating"
                                    type="radio" value="2" @if (old('rating', $review_rating) == '2') checked @endif>
                                ...
                                <input class="review__rating-input visually-hidden" id="rating-1" name="rating"
                                    type="radio" value="1" @if (old('rating', $review_rating) == '1') checked @endif>
                    ...
                    <div class="review__form-group">
                        <div class="review__form-title">
                            <h4 class="review__form-label">口コミを編集</h4>
                        </div>
                        <div class="review__form-content">
                            <div class="review__textarea-wrapper">
                                <textarea class="review__textarea" id="comment" name="comment" maxlength="400" placeholder="カジュアルな夜のお出かけにおすすめのスポット">{{ old('comment', $review_comment) }}</textarea>
                    ...
                    <div class="review__form-group">
                        <div class="review__form-title">
                            <h4 class="review__form-label">画像の追加・削除</h4>
                        </div>
                        <div class="review__form-content">
                            <div class="image-upload__container">
                                ...
                                @enderror
                                <div class="image-upload__preview" id="preview">
                                    @foreach ($review_image_data as $image_data)
                                        <div class="image-container" id="image-container-{{ $image_data['id'] }}">
                                            <img src="{{ $image_data['url'] }}" alt="Uploaded image">
                                            <span class="delete-mark" data-id="{{ $image_data['id'] }}">✕</span>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="review__submit-button-wrapper">
                        <button class="review__submit-button" type="submit">口コミを変更</button>
                    </div>
                </form>
            </div>
        </div>
